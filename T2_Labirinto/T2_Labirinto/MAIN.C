...
int main(void) {
	...
	char comando, parametro; //inicializa a variável comando para entrar no while
	int tam = 3;
	...
	while(comando != 'q') { 
		...
		if (comando == 'i') { //inserir elemento
			...
			LAB_ExisteSolucao( labTeste ); //N sei se essa funcao vai ser a q acha a solucao, mas e a mais proxima do q a gnt tem, entao botei como placeholder
...
int main(void) {
	...
	return 0;
>>>>>>> a631ef608b67765e08caf0c31dc3c53bac7b8ae0
}